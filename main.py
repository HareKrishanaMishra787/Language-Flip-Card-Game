...
try:
    ...
    original_data = pandas.read_csv("data/Korian_words.csv")
...
def next_card():
    ...
    canvas.itemconfig(card_title,text ="Korian" ,fill = "black")
    canvas.itemconfig(card_word, text=current_card["Korian"],fill = "black")
